...
(0, _refs.refs).form.addEventListener("submit", onFormSubmit);
(0, _refs.refs).email.addEventListener("input", (0, _lodashThrottleDefault.default)(onEmailInput, 500));
(0, _refs.refs).message.addEventListener("input", (0, _lodashThrottleDefault.default)(onMessageInput, 500));
...
function userLocaleMessage() {
    try {
        ...
        if (userMessageItem) (0, _refs.refs).message.value = userMessageItem.message;
    } catch (error) {
...
function userlocaleEmail() {
    try {
        ...
        if (userEmailItem) (0, _refs.refs).email.value = userEmailItem.email;
    } catch (error) {
        console.log(error.name);
        console.log(error.message);
    }
...
},{"../scripts/refs":"jHtzO","lodash.throttle":"bGJVT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jHtzO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
